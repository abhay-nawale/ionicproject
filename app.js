    ...
    .config(function ($ionicConfigProvider, $stateProvider, $urlRouterProvider, $mdThemingProvider, $mdIconProvider, $mdColorPalette, $mdIconProvider) {
        ...
        $stateProvider
			...
			.state('app.aboutUs', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/share-application-content/email-message/html/about-us.html",
			...
			.state('app.propertyview', {
				...
				views: {
                    'menuContent': {
                        templateUrl: "templates/share-application-content/email-message/html/property-view.html",
			...
			.state('app.propertyList', {
				...
				views: {
                    'menuContent': {
                        templateUrl: "templates/share-application-content/email-message/html/property-list.html",
            ...
            .state('app.clothShop', {
			 ...
			 .state('app.partners', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/cloth-shop/html/partners.html",
